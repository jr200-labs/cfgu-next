...
description: 'Configu SDK for Node.js published to [npm](https://www.npmjs.com/package/@jr200-labs/node).'
---

## Install

```bash
npm install @jr200-labs/node
yarn add @jr200-labs/node
pnpm add @jr200-labs/node
```
